...
fun LogInScreen(
    ...
    val registrationHyperlinkText = stringResource(id = R.string.registrate)
    val forgetPasswordHyperlinkText = stringResource(id = R.string.forgetPassword)
    ...
    Column(
        ...
        Text(
            text = stringResource(R.string.enterToAppTitle),
        ...
        ClickableText(text = passwordRecoveryString, onClick = {
        ...
        ClickableText(text = registrationString, onClick = {
        ...
        LaunchedEffect(key1 = state.value?.isSuccess) {
            scope.launch {
                if (email.isNotEmpty()) {
                    navController.navigate(Screen.ElementsScreen.route + email)
                }
            }
        }
    }
